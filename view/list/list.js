...
function renderContacts(renderCB, onRenderedCB) {
  ul.innerHTML = '';
  window.parent.performance.mark('request_all_' + renderCount);
  // Contacts service
  if (!contactsService) {
  ...
  stream.listen(function(data) {
    ...
    if (isFirstContact) {
      window.parent.performance.mark('first_contact_' + renderCount);
...
function calcPerformance() {
  isFirstContact = true;
  window.parent.performance.mark('contacts_rendered_' + renderCount);
  window.parent.performance.measure('first_rendered_' + renderCount, 'request_all_' + renderCount, 'first_contact_' + renderCount);
  window.parent.performance.measure('all_rendered_' + renderCount, 'request_all_' + renderCount, 'contacts_rendered_' + renderCount);
